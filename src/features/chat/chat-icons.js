// Chat-page SVG icon set. Shared by chat.js (header / attach panel / input) and
// chat-render.js (action bubbles: location pin, red packet, transfer). Lives in
// its own module so chat.js and chat-render.js can both import it without
